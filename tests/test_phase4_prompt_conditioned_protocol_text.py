...
def test_zero_few_shot_eval_wrapper_runs_all_main_k_settings_on_target_eval():
    ...
    assert 'ADAPTATION_MAX_STEPS="${MAX_STEPS_K4:-${MAX_STEPS:-100}}"' in text
    assert 'ADAPTATION_MAX_STEPS="${MAX_STEPS_K12:-${MAX_STEPS:-80}}"' in text
    assert 'MAX_STEPS="${ADAPTATION_MAX_STEPS}" OUTPUT_DIR="${ADAPT_DIR}"' in text
